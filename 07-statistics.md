...
>> Frequentist theory believes that there is a fixed but unknown reality, that this reality will be reflected in a large number of samples/trials, but that randomness in the sampling will cause noise. Bayesian theory is closer to what lay people think of as statistics - given the evidence, I think the most likely truth is 'blank'. The difference is largely philosophical. Consider for instance counting the number of heads vs tails in a repeated coin toss. The frequentist thinks that there is some true ratio of heads vs tails even if they don't know that probability. After a large number of coin tosses, the frequentist has a confidence interval for said probability. Here, the frequentist is using the evidence to make a model. On the other hand, the Bayesian makes a guess about the likelihood of the ratio of heads before the coin tossing begins. Then after the sequence of outcomes, she updates her beliefs accordingly. After observing the same outcomes, the two likely have similar beliefs about the coin's probability of landing heads. 
